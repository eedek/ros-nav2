...
def start_vehicle_control():
    ...
    @return: A tuple containing ExecuteProcess actions for the joint state
             and ackermann steering controllers.
    """
    ...
    return (joint_state_controller, ackermann_controller)
...
def generate_launch_description():
    ...
    model_package_name="bolid_description"

    model_path = get_package_share_directory(model_package_name)
    package_path = get_package_share_directory(package_name)

    # Set paths to Xacro model and configuration files
    robot_description_path = os.path.join(model_path, 'model',
                                          'vehicle.xacro')
